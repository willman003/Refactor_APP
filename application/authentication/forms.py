...
class Form_token(FlaskForm):
    ten_dang_nhap = fields.StringField('Tên đăng nhập:')
    mat_khau = fields.PasswordField('Mật khẩu:')
    expiration = fields.SelectField('Thời gian tồn tại:',choices=[('3600','3600'),('1800','1800')])
    submit = fields.SubmitField('Đăng nhập hệ thống')